...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		// //创建子节点
		 zk.create("/super/c1", "c1".getBytes(), Ids.OPEN_ACL_UNSAFE,
		 CreateMode.PERSISTENT);
		// 创建子节点
		// zk.create("/super/c2", "c2".getBytes(), Ids.OPEN_ACL_UNSAFE,
		// CreateMode.PERSISTENT);
		// 创建子节点
		// zk.create("/super/c3", "c3".getBytes(), Ids.OPEN_ACL_UNSAFE,
		// CreateMode.PERSISTENT);
		// 创建子节点
		// zk.create("/super/c4", "c4".getBytes(), Ids.OPEN_ACL_UNSAFE,
		// CreateMode.PERSISTENT);

		// zk.create("/super/c4/c44", "c44".getBytes(), Ids.OPEN_ACL_UNSAFE,
		// CreateMode.PERSISTENT);
